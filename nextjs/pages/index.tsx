        ...
        <div className="flex-grow bg-base-300 w-full mt-16 px-8 py-12">
          <div className="flex justify-center items-center gap-12 flex-col sm:flex-row">
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              ...
              <p>
               Lend up to $220 in DAI using your LENS PROFILE NFT as collateral.<br />
                <Link href="/lend" passHref className="link">
               Click here to go to the loans page.</Link><br />
               Interest rate on loans is currently 5% p/a. around 6 cents a day for a $220 loan.<br />
               Max length of a loan is 28 days
              </p>
            </div>
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
